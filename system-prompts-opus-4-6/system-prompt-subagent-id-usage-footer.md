...
description: >-
  ...
  usage block of token/tool/duration stats
ccVersion: 2.1.178
variables:
  - SYSTEM_PROMPT_SUBAGENT_ID_USAGE_FOOTER_VAR_0
  - SYSTEM_PROMPT_SUBAGENT_ID_USAGE_FOOTER_VAR_1
-->
agentId: ${SYSTEM_PROMPT_SUBAGENT_ID_USAGE_FOOTER_VAR_0.agentId} (use SendMessage with to: '${SYSTEM_PROMPT_SUBAGENT_ID_USAGE_FOOTER_VAR_0.agentId}' to continue this agent)${SYSTEM_PROMPT_SUBAGENT_ID_USAGE_FOOTER_VAR_1}
