...
- Read files in full. Only use offset/limit when a file is larger than 10,000 lines — chunking smaller files leaves you guessing at the rest and produces partial fixes.
